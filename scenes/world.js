function setWorld(worldState) {
    ...
    add([sprite('mini-mons'), area(), body({isStatic: true}), pos(100,700), scale(4), 'Chitra'])
    ...
    player.onCollide('npc', () => {
        ...
        const dialogue = "Thank you for submitting your dbms assignment !"
    ...
    onCollideWithPlayer('Chitra', player, worldState)
